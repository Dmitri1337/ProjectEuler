...
namespace ProjectEuler.Problems
{
    ...
    public class Problem0011
    {
        public object GetResult()
        {
            ...
            for (int x = 0; x < 17; x++)
            for (int y = 0; y < 20; y++)
                results.Add(v[y][x] * v[y][x + 1] * v[y][x + 2] * v[y][x + 3]);

            for (int x = 0; x < 20; x++)
            for (int y = 0; y < 17; y++)
                results.Add(v[y][x] * v[y + 1][x] * v[y + 2][x] * v[y + 3][x]);

            for (int x = 0; x < 17; x++)
            for (int y = 0; y < 17; y++)
            {
                results.Add(v[y][x] * v[y + 1][x + 1] * v[y + 2][x + 2] * v[y + 3][x + 3]);
                results.Add(v[y + 3][x] * v[y + 2][x + 1] * v[y + 1][x + 2] * v[y][x + 3]);
            }
